...
<div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
    ...
    <!-- Card -->
    <div class="items-center justify-center w-1/3 bg-white rounded-lg shadow lg:flex md:mt-0 lg:max-w-screen-lg 2xl:max:max-w-screen-lg xl:p-0 dark:bg-gray-800">
        <div class="w-full p-6 space-y-8 sm:p-8 lg:p-8">
            <h2 class="text-2xl text-center font-bold text-gray-900 lg:text-3xl dark:text-white">
                Регистрация
            </h2>
            <form class="mt-8 space-y-6" action="#">
                ...
                <button type="submit" class="w-full px-5 py-3 text-base font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Создать аккаунт</button>
