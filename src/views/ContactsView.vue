    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="px-4 mx-auto max-w-screen-sm text-center lg:px-6 mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Наши контакты</h2>
            ...
            <div class="grid grid-cols-1 lg:gap-8 lg:grid-cols-3">
                <div class="col-span-2 mb-8 lg:mb-0">
                    <form action="#" class="grid grid-cols-1 gap-8 mx-auto max-w-screen-md sm:grid-cols-2">
                        <div>
                            <label for="first-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ваше имя</label>
                        ...
                        <div>
                            <label for="last-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ваша фамилия</label>
                        ...
                        <div>
                            <label for="phone-number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Номер телефона</label>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <p class="mt-4 text-sm text-gray-500">Отправляя эту форму, вы подтверждаете <a href="#" class="text-primary-600 hover:underline dark:text-primary-500">политику обработки персональных данных</a> и нашу <a href="#" class="text-primary-600 hover:underline dark:text-primary-500">политику конфиденциальности</a></p>
                        </div>
                ...
                <div class="grid grid-cols-1 col-span-1 gap-8 text-center sm:grid-cols-2 lg:grid-cols-1">
                    <div>
                        ...
                        <p class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Информация:</p>
                        <p class="text-gray-500 dark:text-gray-400">RCONNECT <br>ОГРН: 12312321312312</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mx-auto mb-4 w-10 h-10 bg-gray-100 rounded-lg dark:bg-gray-800 lg:h-16 lg:w-16">
                    ...
                    <div>
                        ...
                        <p class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Звоните:</p>
                        <p class="mb-3 text-gray-500 dark:text-gray-400">Член нашей команды обязательно ответит вам.</p>
                        <p class="font-semibold text-primary-600 dark:text-primary-500">+7 (999) 786 50-60</p>
                    </div>
                </div>
            </div>
        </div>
