...
export default {
    data() {
        return {
            userSettings: {
                'avatarURL': 'https://random.imagecdn.app/200/200',
                'firstName': 'John',
                'lastName': 'Doe',
                'email': 'john@doe.com',
    ...
    <main class="p-4 md:ml-64 h-auto pt-20 bg-slate-200 dark:bg-gray-900 text-gray-900 dark:text-white">
        <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
            ...
            <div class="col-span-full xl:col-auto">
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4">
                    <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <img class="mb-4 w-28 h-28 rounded-lg sm:mb-0 xl:mb-4 2xl:mb-0" :src="'https://random.imagecdn.app/200/200'" alt="Jese picture">
                        <div>
                            <h3 class="mb-1 text-2xl font-bold text-gray-900 dark:text-white">{{userSettings.firstName}} {{ userSettings.lastName }}</h3>
                            <div class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                                Software Engineer
                            </div>
                            <a href="#" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4">
                    <h3 class="mb-4 text-xl font-bold dark:text-white">Language & Time</h3>
                    <div class="mb-4">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4">
                    <div class="flow-root">
                        <h3 class="text-xl font-bold dark:text-white">Social accounts</h3>
                        <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                            <li class="py-4">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <a href="#" class="block text-sm font-normal text-primary-700 truncate hover:underline dark:text-primary-500">
                                            www.facebook.com/themesberg
                                        </a>
                                    </div>
                                    <div class="inline-flex items-center">
                                        <a href="#" class="py-2 px-3 mr-3 mb-3 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Disconnect</a>
                                    </div>
                                </div>
                            </li>
                            <li class="py-4">
                            ...
                            <li class="py-4">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="inline-flex items-center">
                                        <a href="#" class="py-2 px-3 mr-3 mb-3 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Connect</a>
                                    </div>
                                </div>
                            </li>
                            <li class="pt-4 pb-6">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4">
                    <div class="flow-root">
                        <h3 class="text-xl font-bold dark:text-white">Other accounts</h3>
                                ...
                                <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                    <div class="flex space-x-4 xl:mb-4 2xl:mb-0">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="mb-1 text-sm font-normal text-primary-700 truncate dark:text-primary-500">
                                                New York, USA
                                            </p>
                                    ...
                                    <div class="inline-flex items-center w-auto xl:w-full 2xl:w-auto">
                                        <a href="#" class="py-2 px-3 w-full text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Disconnect</a>
                                    </div>
                                </div>
                            </li>
                            <li class="py-4">
            ...
            <div class="col-span-2">
                    ...
                    <form action="#">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mb-1 text-sm font-normal text-gray-500 dark:text-gray-400">Ensure that these requirements are met:</div>
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4 xl:mb-0">
                <div class="flow-root">
                    ...
                    <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                        <li class="py-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="inline-flex items-center">
                                    <a href="#" class="py-2 px-3 mr-3 mb-3 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Revoke</a>
                                </div>
                            </div>
                        </li>
                        <li class="pt-4 pb-6">
        ...
        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4 xl:mb-0">
            <div class="flow-root">
                <h3 class="text-xl font-bold dark:text-white">Alerts & Notifications</h3>
        ...
        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mb-4 xl:mb-0">
        <div class="flow-root">
            <h3 class="text-xl font-bold dark:text-white">Email Notifications</h3>
