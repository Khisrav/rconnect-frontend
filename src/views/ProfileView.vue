...
<div>
    ...
    <main class="p-4 md:ml-64 pt-20 bg-slate-100 dark:bg-gray-900 text-gray-900 dark:text-white">
        <div class="mx-auto max-w-6xl">
            <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-4">
            <div class="col-span-full mb-4 xl:mb-2">
                <h1 class="text-xl font-bold text-gray-900 sm:text-2xl dark:text-white">Profile</h1>
            </div>
            <!-- Right Content -->
            <div class="col-span-full xl:col-auto">
                <div class="p-4 mb-4 bg-white rounded-2xl sm:p-6 xl:p-8 dark:bg-gray-800">
                <div class="sm:flex xl:block sm:space-x-4 xl:space-x-0">
                    <img class="mb-2 w-20 h-20 rounded-full" :src="avatarSVG" alt="Jese portrait">
                    <div>
                        ...
                        <ul class="mt-2 space-y-1">
                            <li class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                                <svg class="mr-2 w-4 h-4 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>
                                Front-end Developer
                            </li>
                            <li class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                                <svg class="mr-2 w-4 h-4 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>
                                San Francisco, USA
                            </li>
                        </ul>
                    </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-3">
                        <svg class="w-6 h-6" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.1558 0.559692H1.51087C0.676432 0.559692 0 1.23742 0 2.07346V15.7446C0 16.5806 0.676432 17.2583 1.51087 17.2583H15.1558C15.9902 17.2583 16.6667 16.5806 16.6667 15.7446V2.07346C16.6667 1.23742 15.9902 0.559692 15.1558 0.559692Z" fill="#DC395F"/>
                        ...
                        <svg class="w-6 h-6" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.297 0.762876L8.9845 0.259155L13.672 0.762876L17.301 5.71471L8.9845 15.5586L0.667969 5.71471L4.297 0.762876Z" fill="#FDB300"/>
                        ...
                        <svg class="w-6 h-6" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.07892 17.2564C4.61226 17.2564 5.8567 16.0098 5.8567 14.4738V11.6913H3.07892C1.54559 11.6913 0.301147 12.9379 0.301147 14.4738C0.301147 16.0098 1.54559 17.2564 3.07892 17.2564Z" fill="#0ACF83"/>
                            <path d="M0.301147 8.90901C0.301147 7.37305 1.54559 6.12646 3.07892 6.12646H5.8567V11.6916H3.07892C1.54559 11.6916 0.301147 10.445 0.301147 8.90901Z" fill="#A259FF"/>
                            <path d="M0.301025 3.34407C0.301025 1.8081 1.54547 0.561523 3.0788 0.561523H5.85658V6.12662H3.0788C1.54547 6.12662 0.301025 4.88004 0.301025 3.34407Z" fill="#F24E1E"/>
                            <path d="M5.85718 0.561523H8.63495C10.1683 0.561523 11.4127 1.8081 11.4127 3.34407C11.4127 4.88003 10.1683 6.12661 8.63495 6.12661H5.85718V0.561523Z" fill="#FF7262"/>
                            <path d="M11.4127 8.90901C11.4127 10.445 10.1683 11.6916 8.63495 11.6916C7.10162 11.6916 5.85718 10.445 5.85718 8.90901C5.85718 7.37305 7.10162 6.12646 8.63495 6.12646C10.1683 6.12646 11.4127 7.37305 11.4127 8.90901Z" fill="#1ABCFE"/>
                        </svg> 
                        <svg class="w-6 h-6" viewBox="0 0 13 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.12203 1.09285H4.79923V2.63598H5.5665V1.09285H6.24703V0.321289H4.12203V1.09285ZM2.30926 0.321317H1.54199V2.63602H2.31593V1.86445H3.01648V2.63602H3.78375V0.321317H3.01648V1.08618H2.30926V0.321317ZM6.58222 0.321289H7.38618L7.8799 1.13646L8.37362 0.321289H9.17759V2.63598H8.41032V1.4887L7.87323 2.32065L7.33614 1.4887V2.63598H6.58222V0.321289ZM10.3271 0.321289H9.5598V2.63598H11.4146V1.87113H10.3271V0.321289Z" fill="black"/>
                ...
                <div class="flow-root">
                    ...
                    <ul class="flex flex-wrap mt-4">
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Football</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Dogs</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Gaming</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Movies</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Travelling</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Surf</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2 mr-2">Ice Skating</li>
                        <li class="bg-primary-100 dark:bg-primary-200 text-primary-800 text-base font-medium px-3 py-1.5 rounded-md mb-2">The Witcher</li>
                    </ul>
                </div>
                </div>
            </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 95%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="mb-1 text-base font-medium text-gray-500 dark:text-gray-400">Php</div>
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 55%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="mb-1 text-base font-medium text-gray-500 dark:text-gray-400">HTML</div>
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 85%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="mb-1 text-base font-medium text-gray-500 dark:text-gray-400">React</div>
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 65%"></div>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 45%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="mb-1 text-base font-medium text-gray-500 dark:text-gray-400">Marketing</div>
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 90%"></div>
                                </div>
                            </div>
                            <div>
                                <div class="mb-1 text-base font-medium text-gray-500 dark:text-gray-400">Product Design</div>
                                <div class="w-full h-2 bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-2 bg-gray-900 rounded-full dark:bg-white" style="width: 99%"></div>
                                </div>
                            </div>
                            <div>
